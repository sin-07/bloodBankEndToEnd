      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200/80 px-6 py-4 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/auth/register"
              className="text-xs sm:text-sm font-semibold bg-rose-600 text-white px-4 py-2 rounded-xl shadow-sm hover:bg-rose-700 transition-all hover:shadow-rose-600/20"
            >
              Register
            </Link>
          </div>
